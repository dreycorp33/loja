...
settings: id,storeName,storeCnpj,whatsapp,storeLogo,watermarkEnabled,watermarkOpacity,receiptFooter,receiptNote,receiptShowDeveloper,defaultMinStock,discountLimit_json,touchMode,debug,taxRate,themePrimary,themeSecondary,appTitle,sheetEndpoint,trialActive,trialEndsAt
```
