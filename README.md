...
5. Em **Configurações > Dados da loja**, é possível ativar uma marca d'água com a logo.
...
settings: id,storeName,storeCnpj,whatsapp,storeLogo,watermarkEnabled,watermarkOpacity,autoFitEnabled,receiptFooter,receiptNote,receiptShowDeveloper,defaultMinStock,discountLimit_json,touchMode,debug,taxRate,themePrimary,themeSecondary,appTitle,sheetEndpoint,trialActive,trialEndsAt
```
