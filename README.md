...
settings: id,storeName,storeCnpj,whatsapp,storeLogo,watermarkEnabled,watermarkOpacity,autoFitEnabled,receiptFooter,receiptNote,receiptShowDeveloper,defaultMinStock,discountLimit_json,touchMode,debug,taxRate,themePrimary,themeSecondary,appTitle,sheetEndpoint
```
